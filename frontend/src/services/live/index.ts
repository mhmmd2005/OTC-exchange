...
export const authService: AuthService = {
  ...
  register: (input: RegisterInput) => api.post<OtpChallenge>('/auth/register', input),
  requestOtp: (input: RequestOtpInput) => api.post<OtpChallenge>('/auth/otp', input),
  verifyOtp: (input: VerifyOtpInput) => api.post<AuthResult>('/auth/otp/verify', input),
  verifyPasswordResetOtp: (input: VerifyOtpInput) =>
    api.post<PasswordResetProof>('/auth/password/verify', input),
  resetPassword: (input: ResetPasswordInput) => api.post<void>('/auth/password/reset', input),
