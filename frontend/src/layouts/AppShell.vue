...
const collapsed = ref(
    localStorage.getItem('rosha-sidebar-collapsed') === 'true',
)
...
const contextualMobileHeader = computed(
    () => route.meta.mobileHeader === 'contextual',
)
...
<template>
    <div
        ...
        :class="{
            ...
            'mobile-context-route': contextualMobileHeader,
        }"
    >
        <a
            class="skip-link"
...
.sidebar-collapsed .app-shell__content {
...
@media (max-width: 1199px) {
    .mobile-context-route :deep(.app-header) {
        display: none;
    }
}
</style>