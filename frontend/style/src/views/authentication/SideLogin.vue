...
const showVerifyNotice = computed(() => route.query.notice === 'verify-email');
</script>
      ...
      <div class="auth-login-wrapper position-relative rounded-xl mx-lg-16 mx-4 mx-auto w-100">
        <v-card elevation="0" class="overflow-hidden px-sm-3 position-relative z-index-2">
          <v-card-item class="px-sm-8 px-3">
            ...
            <v-alert
              v-if="showVerifyNotice"
              type="info"
              variant="tonal"
              density="comfortable"
              class="mt-4 mb-2"
            >
              Please verify your email. We sent you a verification link. You cannot log in until your email is verified.
            </v-alert>
            ...
            <v-row class="justify-md-space-around align-center py-md-8">
              ...
              <v-col cols="12" lg="5" md="6">
                <div class="mt-xl-0 mt-5 mw-100">
                  <h2 class="text-h2 font-weight-bold mb-2">Welcome to {{ appName }}</h2>
                  ...
                  <h6 class="text-subtitle-1 text-grey100 d-flex align-center mt-6 font-weight-medium">
                    New to {{ appName }}?
                    <v-btn class="pl-0 text-primary text-body-1 opacity-1 pl-2 font-weight-medium" height="auto" to="/register" variant="plain">
                      Create an account
                    </v-btn>
                  </h6>
                </div>
