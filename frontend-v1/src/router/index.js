...
import AdminKycListView from '../views/AdminKycListView.vue'
import AdminKycDetailView from '../views/AdminKycDetailView.vue'
...
const routes = [
  ...
  },
  {
    ...
    component: DashboardLayout,
    children: [
      { path: 'kyc', name: 'admin-kyc', component: AdminKycListView },
      { path: 'kyc/:id', name: 'admin-kyc-detail', component: AdminKycDetailView },
    ],
  },
